...
<head>
    ...
    <title><?php echo PROJECT_NAME; ?> - Catálogo Digital</title>
...
<body>
        ...
        <div class="admin-container">
            <div class="admin-header">
                ...
                <div class="admin-header-actions">
                    <button class="logout-btn" onclick="logoutAdmin()" title="Cerrar Sesión">
            ...
            <div class="tab-content" id="excelTab">
                <div class="excel-import-section">
                    <div class="excel-header">
                        <h3><i class="fas fa-file-excel"></i> Importación Masiva desde Excel</h3>
                        <p>Sube un archivo Excel (.xlsx) con los datos de productos para importación masiva</p>
                    </div>
                    ...
                    <div class="excel-instructions">
                        ...
                        <ul>
                            ...
                            <li><strong>Columna B:</strong> Descripción del producto</li>
                            <li><strong>Columna C:</strong> Cantidad (número)</li>
                            <li><strong>Columna D:</strong> Loc (ubicación o código interno)</li>
                            <li><strong>Columna E:</strong> Precio en US$ (número)</li>
                            <li><strong>Columna F:</strong> Categoría (KTM, Boutique, Frenos, Bujías, Rec General)</li>
                ...
                <div class="table-editor-section">
                    <div class="editor-header">
                        ...
                        <div class="editor-actions">
                            ...
                            <button class="save-all-btn" onclick="console.log('Botón clickeado'); saveAllProducts();">
                    ...
                    <div class="table-info">
                        ...
                        <ul>
                            ...
                            <li>La <strong>Imagen 1</strong> será la imagen de portada</li>
                            <li>Sube imágenes haciendo clic en el botón de imagen</li>
                            <li>Usa <strong>"Agregar Fila"</strong> para nuevos productos</li>
                            <li>Gestiona categorías con el botón <strong>"Gestionar Categorías"</strong></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="categories-content">
                        ...
                        <div class="add-category-section">
                            ...
                            <div class="category-input-group">
                                <input type="text" id="newCategoryName" placeholder="Nombre de la categoría" maxlength="20">
    ...
    <footer class="footer">
        <div class="footer-content">
            <p>&copy; 2025 Catálogo de Liquidación. Todos los derechos reservados.</p>
            <p>Desarrollado por AMS Desarrollos</p>
        </div>
    </footer>

    <!-- Librerías para Excel/CSV -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js"></script>
    <script src="js/main.js"></script>
    <script>
        function saveAllProducts() {
            console.log('Función saveAllProducts ejecutada desde SCRIPT INLINE');
